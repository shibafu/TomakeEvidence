Attribute VB_Name = "ERNoneToOne"
Public Sub NoneToOne()
'
' OneToOn Macro
'
'
    ...
    Set Select2 = ActiveSheet.Shapes.AddShape(msoShapeOval, SelectionTopXPosition + 10, SelectionTopYPosition - 10, _
         20, 20)
    With Select2.Fill
        .Visible = msoTrue
